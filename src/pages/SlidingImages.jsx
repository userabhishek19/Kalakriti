  ...
  return (
    <div className="w-full relative">
      <Slider {...settings} ref={sliderRef}>
        <div className="flex">
          <img className="w-250 md:w-500 lg:w-666 xl:w-800" src={p} alt="Slide 1" />
        ...
        <div className="flex">
          <img className="w-250 md:w-500 lg:w-666 xl:w-800" src={l} alt="Slide 2" />
          <div className="flex-grow bg-gray-800 bg-opacity-90 p-4 text-white">
        ...
        <div className="flex">
          <img className="w-250 md:w-500 lg:w-666 xl:w-800" src={u} alt="Slide 3" />
          <div className="flex-grow bg-gray-800 bg-opacity-90 p-4 text-white">
        ...
        <div className="flex">
          <img className="w-250 md:w-500 lg:w-666 xl:w-800" src={r} alt="Slide 4" />
          <div className="flex-grow bg-gray-800 bg-opacity-90 p-4 text-white">
        ...
        <div className="flex">
          <img className="w-250 md:w-500 lg:w-666 xl:w-800" src={mm} alt="Slide 5" />
          <div className="flex-grow bg-gray-800 bg-opacity-90 p-4 text-white">
        ...
        <div className="flex">
          <img className="w-250 md:w-500 lg:w-666 xl:w-800" src={mu} alt="Slide 6" />
          <div className="flex-grow bg-gray-800 bg-opacity-90 p-4 text-white">
